...
public class SismoController {
    ...
    public ResponseEntity<String> createSismo(@RequestBody List<Map<String, Object>> sismos) {
        ...
        for (Map<String, Object> sismoData : sismos) {
            ...
            String localidadNombre = sismoService.extraerLocalidad(refGeografica);

            // Usar LocalidadService para verificar o crear la localidad
            Localidad localidad = localidadService.verificarOInsertarLocalidad(localidadNombre);

            // Procesar el sismo
            Sismo nuevoSismo = new Sismo();
            nuevoSismo.setLocalidadId(localidad.getId());
            nuevoSismo.setLocalidad(localidad.getNombre());
            ...
            if (!sismoService.sismoYaProcesado(nuevoSismo)) {
                ...
                localidadesIds.add(localidad.getId());
            } else {
        ...
        // Manejar suscripciones y envío de correos
